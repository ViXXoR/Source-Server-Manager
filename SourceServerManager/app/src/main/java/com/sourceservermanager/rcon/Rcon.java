...
public abstract class Rcon {
     ...
     */
    public static String send(int localPort, String ipStr, int port, String password, String command, String rconTimeout)
            throws SocketTimeoutException, BadRcon, ResponseEmpty {

        RconPacket[] requested = sendRequest(localPort, ipStr, port, password, command, rconTimeout);
    ...
    private static RconPacket[] sendRequest(int localPort, String ipStr, int port, String password,
                                            String command, String rconTimeout) throws SocketTimeoutException {
        ...
        try {
            ...
            socket.setSoTimeout(Integer.parseInt(rconTimeout)*1000);
